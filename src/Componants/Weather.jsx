...
const Weather = () => {
  ...
  return (
    <div className='container mx-auto py-8'>
      ...
      {weatherData && !loading && (
        <div className='mt-8 p-4 rounded-lg grid grid-cols-2 items-start gap-4 max-w-[800px] mx-auto'>
          <div className='flex gap-4 p-5 rounded-xl bg-slate-100 shadow-md'>
            <div>
